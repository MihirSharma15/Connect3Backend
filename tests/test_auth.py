...
def test_verify_code(client):
    ...
    response = client.post(
        "/auth/verify-code", json={"phonenumber": test_phone, "code": test_code}
    )
    ...
    test_phonenumber = UserPhonenumber(phonenumber=test_phone)

    assert verify_phone_verification_token(
        token=test_token, phonenumber=test_phonenumber
    )
